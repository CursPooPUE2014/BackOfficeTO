...
public class ConsultaUsuariocliente extends Action {
	 ...
	 public ActionForward execute(ActionMapping mapping, ActionForm form,
			...
			try {
				...
				clientdao.findByKey(usuclient, Integer.class);
				
				json.put("cliente", usuclient);
							
			} catch (IOException e) {

				json.put("mens", "Error! Cliente no encontrado");
			}
